...
if ($kat_id != '') {
    ...
    $objResult = odbc_fetch_array($rs); //kat sini ade salah....odbc_fetch_ array() <<ade space pule
    if ($objResult) {
        $jum_p = $objResult["Bil"];
        $jum_f = ceil($jum_p / 4);
    }
        ...
        <td>
            <form name="frmFlight" id="frmFlight" action="flightPlayer.php" method="post">
                ...
                <table width="100%" id="Main" align="center">
                    <tr>
                        <td width="90%" align="left" style="font-size:17px"><strong>Penentuan 'Flight'
                                Pemain</strong></strong></td>
                        <td width="10%" align="left" style="font-size:17px"><a href="menuUtiliti.php"><img
                                    src="image/menu utama.jpg" width="120" height="35" align="right"/></a></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        <input type="text" name="txtJumP" id="txtJumP" size="10" style="width:50px;"
                                               readonly="readonly" value="<?php echo $jum_p; ?>"/> orang
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6" align="right">
                                        ...
                                        <input type="submit" class="button" name="btnsimpan" id="btnsimpan"
                                               value="Proses" style="width:90px; text-align:center;"
                                               onClick="return SimpanRekod()"/>
                                        <input type="submit" class="button" name="btnhapus" id="btnhapus"
                                               value="Batal Proses" style="width:90px; text-align:center;"
                                               onclick="return HapusRekod()"/>
                                    </td>
                                </tr>
                            </table>
                                                ...
                                                while ($objResult) {
                                                    if ($i % 2 == 0) {
                                                        ...
                                                        <tr class="listoff" style="background-color:#FFF">
                                                            <td width="10%"
                                                                valign="middle"><?php echo $objResult["F_ID"]; ?></td>
                                                            ...
                                                            <td width="22%"><?php if ($objResult["P4"] != "") {
                                                                    echo $objResult["P4"] . "<br>" . $objResult["P4_Nama"] . "<br>(" . $objResult["P4_IPT"] . ")";
                                                                } else echo ""; ?></td>
                                                        </tr>
                                                    <?php
                                                    } else {
