...
<?php
	...
	function Simpan()
	{
		...
		$rs = mydb("SELECT F_ID FROM FlightD1 WHERE Kat_ID='$kat_id'");
		$objResult = odbc_fetch_array($rs);  
		if($objResult)
		{
			$f=$objResult["F_ID"];
...
<tr>
    ...
    <form name="frmFlight" id="frmFlight" action ="holetoflight.php" method="post">
        ...
        <table width="100%" id="Main" align="center">
            <tr>
                <td width="90%" align="left" style="font-size:17px"><strong>Penentuan Flight Kepada Hole </strong></strong></td>
            ...
            <tr>
                <td colspan="2" align="center">
					...
					<tr>
                        ...
                        <td width="2%">:</td>
                        <td width="30%">
                            <input type="text" name="txtJumP" id="txtJumP" size="10" style="width:50px;" readonly="readonly" value="<?php echo $jum_h;?>"/></td>
							...
							<div class=listbox style="height:400px">
                                ...
                                ?>
                                           <tr class="listoff" style="background-color:#FFF">
                                                <td width="39%" valign="middle"><?php echo $objResult["H_ID"] ;?></td>
